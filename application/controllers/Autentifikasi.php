...
terdaftar!</div>' );
    ...
    public function logout()
    {
        ...
        $this->session->set_flashdata( 'pesan', '<div class="alert alert-success alert-message" role="alert">Kamu telah logout!!</div>' );
        redirect( 'autentifikasi' );
    ...
    public function registrasi()
    {
        ...
        if ($this->form_validation->run() == false) 
        {
            ...
            $this->session->set_flashdata('pesan', '<div class="alert alert-success alert-message" role="alert">Selamat! akun member kamu sudah berhasil dibuat. Silahkan Aktivasi Akunmu</div>');
            redirect('autentifikasi');
        }
    }
}
